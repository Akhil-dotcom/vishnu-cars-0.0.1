...
function Pricing() {
    return (
        <div className="pricing">
            <div className="pricing__head">What courses we provide for your advancement.</div>
                    ...
                    return (
                        <div className="pricing__main" key={value.id}>
                            <div className="pricing__content">
                                ...
                                <div className="pricing__content__button"><Button className="btn" variant='contained' color='primary'>Sign Up</Button></div>
                            </div>
                        </div>
                    )
                })
